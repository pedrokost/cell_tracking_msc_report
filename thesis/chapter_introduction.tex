	...
	\section{Report structure \statusfirstdraft}
		...
		\Cref{chap:relatedwork} is a brief literature survey outlining existing methods for cell detections and tracking. The chapter gives a background of how the methods for cell detection and tracking have evolved over time.
