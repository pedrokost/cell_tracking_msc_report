	...
	\section{Report structure \statusfirstdraft}
		...
		\Cref{chap:cell_detection} describes in more depth the cell detector from Arteta et al \cite{arteta12} and outlines the modification that improved the detection speed.
