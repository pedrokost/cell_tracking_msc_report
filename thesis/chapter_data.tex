\chapter{Data acquisition and annotation \statusfirstdraft}
	...
	\begin{figure}[h]
   	...
   	\todo{Explain why detection can be bad on this dataset}
    ...
    \todo{Exaplain how the quality decreases and fewer and fewer cells are visible up to a certain frame, after which the quality is reset and cells appear again}
	...
	\todo{Write about the manual annotation process}
	\todo{Write about the challenges of consistent annotations}
	\todo{Write about that we can't completely trust the annotations}
	\todo{Check in the original place where I wrote about he problems of manual annotations}
